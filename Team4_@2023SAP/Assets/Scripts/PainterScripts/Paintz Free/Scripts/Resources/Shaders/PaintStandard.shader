Shader "Paint/PaintStandard" {
	Properties{
		...
		_SplatColor1("Splat Color 1", Color) = (1,.5,0,1)//orange 
		_SplatColor2("Splat Color 2", Color) = (1,0,0,1)//red
		_SplatColor3("Splat Color 3", Color) = (0,0,1,1)//blue
		_SplatColor4("Splat Color 4", Color) = (0,1,0,1)//green
